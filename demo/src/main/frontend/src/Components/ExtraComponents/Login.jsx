                        ...
                        <div className="lg:w-6/12 px-4 md:px-0">
                            <div className="md:p-12 md:mx-6">
                                ...
                                <form>
                                    ...
                                    <div className="flex flex-nowrap border-none relative items-stretch w-full mb-4">
                                        {/* input-group-text */}
                                    ...
                                    <div className="flex relative flex-nowrap border-none relative items-stretch w-full mb-4">
                                        {/* input-group-text */}
                                        ...
                                        <input id="password" type={values.showPassword ? "text" : "password"} className="h-12 border rounded-r-lg w-full mb-3 leading-6 text-justify pl-1" onChange={handlePasswordChange}/>
                                    ...
                                    <div className="text-center pt-1 mb-12 pb-1">
                                        ...
                                        className="px-6 py-2.5 text-white font-medium text-xs uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full mb-3"
                                        type="button"
