...
public class RemoveAllEmbeddedFontsDemo
{
    static
    {
        ...
        PdfException
    {
        try
        {
            ...
            //call PdfDocument.replaceAllEmbeddedFonts(PdfFont replaceWithFont)
            pdfDoc.replaceAllEmbeddedFonts(replaceWithFont);
        ...
        catch (ArrayIndexOutOfBoundsException e)
        {
            ...
            .println("Usage : java DocAttachmentsRemovingDemo "
                + "<input file path> <0utput file path> <replace_font_name_or_file>");
        }
    }
