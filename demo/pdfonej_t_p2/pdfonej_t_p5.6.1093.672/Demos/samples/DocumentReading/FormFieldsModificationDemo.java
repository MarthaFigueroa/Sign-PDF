...
/*
 * FormFieldModifySampleDemo demonstrates - how to create a Pdf
 * Document by modifying all the form fields from an existing PdfDocument.
 */
public class FormFieldsModificationDemo
{
    static
    {
        ...
        IOException
    {
        try
        {
            ...
            /*set's fileds appearence as visible*/
            document.setOverrideFieldAppearanceStreams(true);

            /*get the desired page from the document*/
            PdfPage page = document.getPage(1);

            /* get the arraylist of form fields from the page */
            ArrayList formFieldsList = (ArrayList) page
                .getAllFormFields();
            ...
            //open's the document after save
        ...
        {
            System.out.println("Usage : java FormFieldsModificationDemo " +
