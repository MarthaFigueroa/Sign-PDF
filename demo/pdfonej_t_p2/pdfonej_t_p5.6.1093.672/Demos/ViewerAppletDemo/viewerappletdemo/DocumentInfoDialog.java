...
class DocumentInfoDialog extends JDialog
{
    ...
    public void updateDocumentInfo(PdfDocument d)
    {
        // set values for the fields in the Description Panel
        String inputFileName = d.getInputFileName();
        ...
        txtKeywords.setText(d.getKeywords());
...
//        SimpleDateFormat df = new SimpleDateFormat("");
        ...
        Date modifiedDate = d.getModifiedDate();
        ...
        lblApplication.setText(d.getCreator());
        
        // set values for the fields in the Adavanced Panel
        lblPdfProducer.setText(d.getProducer());
        lblPdfVersion.setText(d.getVersion());
        ...
        lblSecurity.setText(d.isEncrypted()? "Yes" : "No");
    }
}
